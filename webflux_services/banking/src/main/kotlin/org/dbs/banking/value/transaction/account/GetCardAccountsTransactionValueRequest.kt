...
import org.dbs.validator.Field.SOME_ACCOUNT_TRANSACTION_CODE
        ...
        object {
            ...
            fun validateRequest() = response.run {
                ...
                validateParamPatternIfPresent(
                    serverRequest,
                    QP_TRANSACTION_CODE,
                    NUM_ACCOUNT_TRANSACTION_PATTERN, SOME_ACCOUNT_TRANSACTION_CODE
                ) {
