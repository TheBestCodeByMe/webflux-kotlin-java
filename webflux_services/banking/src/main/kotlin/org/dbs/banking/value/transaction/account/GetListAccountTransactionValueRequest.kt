...
import org.dbs.validator.Field.SOME_ACCOUNT_TRANSACTION_DATE
import org.dbs.validator.Field.SOME_ACCOUNT_TRANSACTION_KIND
import org.dbs.validator.Field.SOME_ACCOUNT_TRANSACTION_STATUS
import org.dbs.validator.Field.SOME_ACCOUNT_TRANSACTION_SUM
import org.dbs.validator.Field.SOME_CUSTOMER_ACCOUNT_CODE
        ...
        object {
            ...
            fun validateRequest() = response.run {
                ...
                validateParamPatternIfPresent(
                    ...
                    STATUS_NAME_PATTERN, SOME_ACCOUNT_TRANSACTION_STATUS
                ) {
                ...
                validateParamPatternIfPresent(
                    ...
                    STATUS_NAME_PATTERN, SOME_ACCOUNT_TRANSACTION_KIND
                ) {
                ...
                validateParamPatternIfPresent(
                    ...
                    DATE_TIME_PATTERN, SOME_ACCOUNT_TRANSACTION_DATE
                ) {
                ...
                validateParamPatternIfPresent(
                        serverRequest,
                        QP_TRANSACTION_SUM,
                        MONEY_PATTERN, SOME_ACCOUNT_TRANSACTION_SUM
                ) {
                    validateMoney(it.toBigDecimal(), OC_INVALID_ACCOUNT_TRANSACTION_SUM, SOME_ACCOUNT_TRANSACTION_SUM)
                ...
                validateParamPatternIfPresent(
                    ...
                    BANK_ACCOUNT_PATTERN_LIGHT_MASK, SOME_CUSTOMER_ACCOUNT_CODE
                ) {
