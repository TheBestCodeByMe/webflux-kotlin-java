...
rootDir
    ...
    .filter {
        it.name != buildSrcFolder
                && (!it.name.contains("some"))
                && it.isDirectory
                && !it.absolutePath.contains(deprecatedFolder)
                && file("${it.absolutePath}/$buildFile").exists()
    }
...
fun updateReleaseDate(banner: File) = if (banner.exists()) {
    val fileName = banner.absolutePath
    val now = now().format(ofPattern("dd.MM.yyyy HH:mm:ss"))

    Path(fileName).writeLines(banner.readLines().map {
        if (it.contains("Build Date")) {
            it.substring(0, it.indexOf(":") + 2).plus(now)
        } else it
    })
} else {
    // do nothing
    println("### file ${banner.absolutePath} does not exists")
}
...
//        val dstSslFileName = "${it.absolutePath}/$resourceFolder/$sslCertName"
        ...
        // update release date in banner
        val bannerFile = "${it.absolutePath}/$resourceFolder/$bannerFileName"
        //println("bannerFile = ${bannerFile}")
        updateReleaseDate(File(bannerFile))
...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            val apacheCommonsVersion = "apache.commons.version"
            val apacheCommonsCollections4Version = "apache.commons.collections4.version"
            ...
            val kotestAssertionVersion = "kotest.assertion.version"
            ...
            check(current().isCompatibleWith(VERSION_17)) {
                "This project needs to be run with Java 17 or higher (found: ${current()})" }
            ...
            library("spring-starter-test-autoconfigure", springBootGroup, "spring-boot-test-autoconfigure").versionRef(
                springBootVersion
            )
            // spring-cloud
            version(springCloudVersion, springCloudLibVersion)
            library("spring-cloud-starter-gateway", springBootCloudGroup, "spring-cloud-starter-gateway").versionRef(
                springCloudVersion
            )
            //==========================================================================================================
            // spring-data
            ...
            library(
                ...
                springBootCloudGroup,
                "spring-cloud-starter-netflix-eureka-server"
            ).versionRef(springCloudVersion)
            library(
            ...
            library(
                ...
                springBootCloudGroup,
                "spring-cloud-starter-loadbalancer"
            ).versionRef(springCloudBalancerVersion)
            library("spring-cloud-loadbalancer", springBootCloudGroup, "spring-cloud-loadbalancer").versionRef(
                springCloudBalancerVersion
            )
            // spring-cloud-dependencies
            version(springCloudDependenciesVersion, springCloudDependenciesLibVersion)
            library("spring-cloud-dependencies", springBootCloudGroup, "spring-cloud-dependencies").versionRef(
                springCloudDependenciesVersion
            )
            // spring-security
            version(springSecurityVersion, springSecurityLibVersion)
            library("spring-security-jwt", springBootSecurityGroup, "spring-security-jwt").versionRef(
            ...
            library("jakarta-validation", "jakarta.validation", "jakarta.validation-api").versionRef(
                jakartaValidationVersion
            )
            // metrics
            version(micrometerPrometheusVersion, micrometerPrometheusLibVersion)
            library("micrometer-prometheus", micrometer, "micrometer-registry-prometheus").versionRef(
                micrometerPrometheusVersion
            )
            // jmh
            ...
            library("jackson-dataformat-xml", "com.fasterxml.jackson.dataformat", "jackson-dataformat-xml").versionRef(
                fasterXmlJacksonDataformatVersion
            )
            // jackson.module
            version(fasterXmlJacksonModuleVersion, fasterXmlJacksonModuleLibVersion)
            library("jackson-module-kotlin", "com.fasterxml.jackson.module", "jackson-module-kotlin").versionRef(
                fasterXmlJacksonModuleVersion
            )
            // reflections
            ...
            library("springdoc-openapi-webflux-ui", springDocGroup, "springdoc-openapi-starter-webflux-ui").versionRef(
                springdocVersion
            )
            library("springdoc-openapi-kotlin", springDocGroup, "springdoc-openapi-kotlin-starter-common").versionRef(
                springdocVersion
            )
            // jboss
            ...
            // apache
            version(apacheCommonsVersion, apacheCommonsLibVersion)
            library("commons-lang3", "org.apache.commons", "commons-lang3").versionRef(apacheCommonsVersion)
            version(apacheCommonsCollections4Version, apacheCommonsCollections4LibVersion)
            library("commons-collections4", "org.apache.commons", "commons-collections4").versionRef(
                apacheCommonsCollections4Version
            )
            // nimbusds
            ...
            library("blockhound-junit-platform", "io.projectreactor.tools", "blockhound-junit-platform").versionRef(
                blockhoundJunitPlatformVersion
            )
            ...
            library("reactor-kotlin-extensions", "io.projectreactor.kotlin", "reactor-kotlin-extensions").versionRef(
                reactorKotlinExtensionsVersion
            )
            // testcontainers
            ...
            library("testcontainers-junit-jupiter", "org.testcontainers", "junit-jupiter").versionRef(
            ...
            // kotest
            version(kotestAssertionVersion, kotestLibVersion)
            library("kotest-bom", "io.kotest", "kotest-bom").versionRef(kotestAssertionVersion)
            library("kotest-assertions-core", "io.kotest", "kotest-assertions-core").versionRef(kotestAssertionVersion)
            library("kotest-assertions-core-jvm", "io.kotest", "kotest-assertions-core-jvm").versionRef(
                kotestAssertionVersion
            )
            library("kotest-runner-junit5-jvm", "io.kotest", "kotest-runner-junit5-jvm").versionRef(
                kotestAssertionVersion
            )
            library("kotest-property-jvm", "io.kotest", "kotest-property-jvm").versionRef(kotestAssertionVersion)
            library("kotest-common-jvm", "io.kotest", "kotest-common-jvm").versionRef(kotestAssertionVersion)
            ...
            library("kotest-extensions-spring", "io.kotest.extensions", "kotest-extensions-spring")
                .versionRef(kotestSpringExtensionVersion)
            // kotest - testcontainers
            version(kotestTestContainersExtensionVersion, kotestTestContainersExtensionLibVersion)
            library("kotest-testcontainers", "io.kotest.extensions", "kotest-extensions-testcontainers")
                .versionRef(kotestTestContainersExtensionVersion)
            // kotlin-jacoco
            ...
            library("grpc-server-autoconfigure", "net.devh", "grpc-server-spring-boot-autoconfigure").versionRef(grpcServerSpringBootVersion)
            // grpc-spring-boot
            ...
            library("jakarta-annotation-api", "jakarta.annotation", "jakarta.annotation-api").versionRef(
            ...
            library("kotlin-stdlib-common", "org.jetbrains.kotlin", "kotlin-stdlib-common").versionRef(
                jetbrainsKotlinVersion
            )
            library("kotlin-stdlib-jdk8", "org.jetbrains.kotlin", "kotlin-stdlib-jdk8").versionRef(
                jetbrainsKotlinVersion
            )
            library("kotlin-osgi-bundle", "org.jetbrains.kotlin", "kotlin-osgi-bundle").versionRef(
                jetbrainsKotlinVersion
            )
            library("kotlin-gradle-plugin", "org.jetbrains.kotlin", "kotlin-gradle-plugin").versionRef(
                jetbrainsKotlinVersion
            )
            library("kotlin-script-runtime", "org.jetbrains.kotlin", "kotlin-script-runtime").versionRef(
                jetbrainsKotlinVersion
            )
            ...
            library(
                ...
                "kotlin-reflect"
            ).versionRef(jetbrainsKotlinReflectVersion)
            // kotlin-noarg
            ...
            library("kotlin-serialization-json", "org.jetbrains.kotlinx", "kotlinx-serialization-json")
                .versionRef(kotlinSerializationVersion)
            // minio
            ...
            // corutines-reactive
            library("coroutines-reactor", "org.jetbrains.kotlinx", "kotlinx-coroutines-reactor").versionRef(
                kotlinxVersion
            )
            library("coroutines-reactive", "org.jetbrains.kotlinx", "kotlinx-coroutines-reactive").versionRef(
                kotlinxVersion
            )
            ...
            library("bucket4j-core", "com.github.vladimir-bukhtoyarov", "bucket4j-core").versionRef(bucket4jVersion)
            // jsoup
