...
import dsl.Dependencies.Projects.ACTORS_GRPC_CLIENT
import dsl.Dependencies.Projects.ACTORS_PROTO_API
...
import dsl.Dependencies.Projects.QUIZ
import dsl.Dependencies.Projects.QUIZ_API
import dsl.Dependencies.Projects.QUIZ_PROTO_API
...
dependencies {
    ...
    api(project(ACTORS_GRPC_CLIENT))
    testApi(project(ACTORS_API))
    ...
    implementation(project(QUIZ_PROTO_API))
    implementation(project(PROTOBUF_API_SRC))
    implementation(project(ACTORS_PROTO_API))
